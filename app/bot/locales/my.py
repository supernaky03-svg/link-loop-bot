TEXTS: dict[str, str] = {
    ...
    'language': 'ဘာသာစကား',
    'cancelled': 'ပယ်ဖျက်ပြီး ပင်မ Menu သို့ ပြန်သွားပါပြီ။',
    'back': '⬅️ နောက်သို့',
    'cancel': '❌ မလုပ်တော့ပါ',
    'confirm': '✅ အတည်ပြုမယ်',
    'recheck': '🔄 ပြန်စစ်မယ်',
    ...
    'admin_missing': 'Admin permission မပြည့်စုံပါ။',
    'missing_admin_footer': 'Bot ကို Post Messages permission ဖြင့် admin ပေးပြီး Recheck နှိပ်ပါ။',
